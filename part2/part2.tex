...
\begin{frame}{Determinism in $\FinStoch$}
	...
	\begin{example}
		...
		\pause
		\neq \includegraphics[align=c, scale=0.15]{part2/BarCharts/diagonal_dist}
...
\begin{frame}{And the Moral of that is \dots}
	\begin{minipage}{0.4\linewidth}
		\begin{center}
			\makebox[\textwidth]{\includegraphics[width=\linewidth]{part2/Figures/1-the-duchess-wikipedia-1005378393.png}}
		\end{center}		
	\end{minipage}
%	\pause
	\begin{minipage}{0.59\linewidth}
...
%			\\
		...
		$\cat{Poss}$ %with morphisms 		\includegraphics[scale=0.4]{part2/Figures/morphisms_poss} 
%			\begin{equation*}
%			\begin{split}
%			f : X &\to 2^Y	
%			\quad \text{i.e.~}
...
%		\begin{tikzpicture}
%		\draw (0, 0) node[inner sep=0] {\includegraphics[width=\linewidth]{part2/Figures/1-the-duchess-wikipedia-1005378393.png}};
